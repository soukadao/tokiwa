 ...
 */
export type EventHandler<TPayload = unknown> = (event: Event<TPayload>, context: HandlerContext) => void | Promise<void>;
/**
 * サブスクライバー作成時のオプション設定。
 */
 ...
 * @typeParam TPayload - イベントペイロードの型
 */
export declare class Subscriber<TPayload = unknown> {
    /** サブスクライバーの一意な識別子 */
    readonly id: string;
    /** 購読対象のイベントタイプ */
     ...
     */
    constructor(type: string, handler: EventHandler<TPayload>, options?: SubscriberOptions);
}
