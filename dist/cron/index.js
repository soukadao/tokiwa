...
var Cron = class _Cron {
   ...
   */
  getNextExecution(after = new TZDate()) {
...
var Scheduler = class _Scheduler {
  ...
  scheduleNextCheck() {
    ...
    const delay = this.checkIntervalMs === DEFAULT_CHECK_INTERVAL_MS ? _Scheduler.getDelayUntilNextMinute(new TZDate()) : this.checkIntervalMs;
